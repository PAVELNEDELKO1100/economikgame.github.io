...
<html lang="en" class="html-fluid">
  ...
  <meta name="request-id" content="987E:39E6:13CE86E:18B32AC:6024E0A6" data-pjax-transient="true"/><meta name="html-safe-nonce" content="2aef549ac9f5348b0dbcc05f21676cb0ebbc7802cc396f024c5fd6225788d996" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI5ODdFOjM5RTY6MTNDRTg2RToxOEIzMkFDOjYwMjRFMEE2IiwidmlzaXRvcl9pZCI6Ijc0Mjk5MTg2NDkxNDE3NDc4NzgiLCJyZWdpb25fZWRnZSI6ImZyYSIsInJlZ2lvbl9yZW5kZXIiOiJmcmEifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="ecdbad9bfab663911f537928133e1ef3e78735a97dedced169b2eee444c1395c" data-pjax-transient="true"/>
  ...
  <meta http-equiv="x-pjax-version" content="98cd66e3ca8e2848e67952f7742932c043e658a9053df64916d5e08ef69b0d61">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-unscoped-search-url="/search" action="/search" accept-charset="UTF-8" method="get">
      <label class="form-control input-sm header-search-wrapper p-0 js-chromeless-input-container header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center">
        <input type="text"
          ...
          autocomplete="off"
          >
          <input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="jyeMMp6ySyZZS2XCtJcjvW8AaAgL89bGKDaMR3gfl2kR/+B7iMyWnry1KTSGpnsS4KsjjJ1ShkdEvXMBTRTO9Q==" />
      ...
      <div class="d-flex gutter-fluid gutter-spacious-fluid flex-column flex-lg-row flex-items-center height-full  px-0-fluid px-lg-3-fluid">
        <div class="ml-md-n3 mr-md-3 col-12 col-lg-6 text-center text-md-left">
          ...
          <p class="f4-mktg-fluid f2-sm-mktg-fluid text-gray-light-mktg mr-lg-n4-fluid mb-4-fluid lh-condensed lh-sm-default position-relative z-2">Millions of developers and companies build, ship, and maintain their software on GitHub—the largest and most advanced development platform in the&nbsp;world.</p>
            ...
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="mx-auto mx-md-0 col-5-max js-signup-form position-relative z-2" autocomplete="off" action="/join" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="XHrOYUtEfsucCtGpeyqkmyQrJJtBZML8jz3ErGKo2GjzBd/ise79NuHHXsedyr2tDz5gQkoOTau2TlWuD3qrBw==" />              <div class="d-flex flex-column flex-sm-row flex-items-center">
                  ...
                  <div class="col-12 col-lg-5">
                    <div  class="js-build-in-item home-codeql-comp position-relative pt-9-fluid">
                      <div class="home-codeql-step-3 rounded-2-fluid position-absolute box-shadow-active-border-light-mktg">
                        <picture>
                          <source srcset="https://github.githubassets.com/images/modules/site/home/codeql-step-3.webp">
                      ...
                      <div class="home-codeql-step-2 rounded-2-fluid position-absolute box-shadow-active-border-light-mktg">
                        <picture>
                          <source srcset="https://github.githubassets.com/images/modules/site/home/codeql-step-2.webp">
        ...
        <div class="col-12 offset-1 position-relative">
          <ul class="home-git-log-light d-flex gutter-fluid gutter-spacious-fluid flex-column list-style-none pb-md-12-fluid mb-12-fluid">
            ...
            <li class="col-12 d-flex flex-items-center position-relative f5-mktg-fluid text-gray-light-mktg py-2-fluid unselectable" aria-hidden="true">
              ...
              <img src="https://avatars.githubusercontent.com/sophshep?v=4" class="d-none d-sm-block flex-shrink-0 avatar avatar-4 mr-3-fluid circle bg-gray" alt="@sophshep" loading="lazy">
            ...
            <li class="col-12 d-flex flex-items-center position-relative f5-mktg-fluid text-gray-light-mktg py-2-fluid unselectable" aria-hidden="true">
              ...
              <img src="https://avatars.githubusercontent.com/joshaber?v=4" class="d-none d-sm-block flex-shrink-0 avatar avatar-4 mr-3-fluid circle bg-gray" alt="@joshaber" loading="lazy">
            ...
            <li class="col-12 d-flex flex-items-center position-relative f5-mktg-fluid text-gray-light-mktg py-2-fluid unselectable" aria-hidden="true">
              ...
              <img src="https://avatars.githubusercontent.com/pmarsceill?v=4" class="d-none d-sm-block flex-shrink-0 avatar avatar-4 mr-3-fluid circle bg-gray" alt="@pmarsceill" loading="lazy">
                ...
                <div class="col-12 col-lg-5">
                  <div class="js-build-in-item home-sponsors-comp">
                    <div class="rounded-2-fluid box-shadow-default-border-mktg position-relative z-1 home-sponsors-1">
                      ...
                      <picture>
                        <source srcset="https://github.githubassets.com/images/modules/site/home/community-sponsor-1.webp" type="">
  ...
  <div class="container-xl p-responsive-fluid">
    <picture>
      ...
      <img
        ...
        class="home-footer-illustration position-relative z-1 width-full d-block events-none" loading="lazy" decoding="async">
    </picture>
          ...
          <div class="width-full flex-shrink-0 offset-1 offset-lg-3 d-flex flex-justify-center gutter-condensed-fluid gutter-lg-fluid py-2-fluid py-lg-3-fluid">
            <div class="col-3">
              <a href="/tensorflow/tensorflow" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:tensorflow/tensorflow;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/tensorflow?v=4" alt="Tensorflow" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="gatsbyjs/gatsby" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:gatsbyjs/gatsby;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/gatsbyjs?v=4" alt="Gatsby" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="home-assistant/core" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:home-assistant/core;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/home-assistant?v=4" alt="Home Assistant" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
          ...
          <div class="width-full offset-lg-2 d-flex flex-justify-center gutter-condensed-fluid gutter-lg-fluid py-2-fluid py-lg-3-fluid">
            <div class="col-3">
              <a href="/rust-lang/rust" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:rust-lang/rust;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/rust-lang?v=4" alt="The Rust Programming Language" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="/flutter/flutter" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:flutter/flutter;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/flutter?v=4" alt="Flutter" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="/kubernetes/kubernetes" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:kubernetes/kubernetes;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/kubernetes?v=4" alt="Kubernetes" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
          ...
          <div class="width-full offset-1 d-flex flex-justify-center gutter-condensed-fluid gutter-lg-fluid py-2-fluid py-lg-3-fluid">
            <div class="col-3">
              <a href="/apple/swift" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:apple/swift;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/apple?v=4" alt="Kubernetes" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="/ansible/ansible" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:ansible/ansible;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/ansible?v=4" alt="Ansible" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="/hashicorp/terraform" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:hashicorp/terraform;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/hashicorp?v=4" alt="Hashicorp" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
          ...
          <div class="width-full offset-lg-n1 d-flex flex-justify-center gutter-condensed-fluid gutter-lg-fluid py-2-fluid py-lg-3-fluid">
            <div class="col-3">
              <a href="/ohmyzsh/ohmyzsh" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:ohmyzsh/ohmyzsh;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/ohmyzsh?v=4" alt="Oh my zsh" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="/facebook/react" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:facebook/react;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/facebook?v=4" alt="Facebook" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
            ...
            <div class="col-3">
              <a href="/npm/cli" class="home-repo-card js-home-repo-card d-block p-3-fluid rounded-2-fluid box-shadow-card-border-light-mktg text-gray-light-mktg no-underline" data-ga-click="Home, click to go to repository, ref_page:/;ref_cta:npm/cli;ref_loc:footer launchpad;">
                <div class="d-flex flex-items-center mb-2-fluid">
                  <img src="https://avatars.githubusercontent.com/npm?v=4" alt="npm" class="bg-white avatar avatar-5 rounded-2-fluid mr-2-fluid" loading="lazy" decoding="async">
